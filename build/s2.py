...
d.add('Portada', 'cover', cover(
    ...
    'Sesión 2 de 2 · 12 laboratorios con Excel, expedientes Word, controles y aprobación humana · 180 minutos.',
...
d.add('Agenda', 'paper', agenda(
    ...
    [('01 · BLOQUE 1 · 45 MIN', 'El Excel antes de la reunión',
      [('Calidad', '15 MIN'), ('Guatemala', '15 MIN'), ('Domicilio', '15 MIN')]),
     ('02 · BLOQUE 2 · 40 MIN', 'Documentos que cambian decisiones',
      [('Cotización', '10 MIN'), ('Expediente', '15 MIN'), ('Borrador', '15 MIN'),
       ('Pausa antes del bloque 3', 'PAUSA · 15 MIN')]),
     ('03 · BLOQUE 3 · 40 MIN', 'Antes de publicar el expediente',
      [('Paquete', '10 MIN'), ('Código interior', '15 MIN'), ('Documento hostil', '15 MIN')]),
     ('04 · BLOQUE 4 · 40 MIN', 'Cerrar junio',
      [('Sección', '10 MIN'), ('Paquete gerencial', '15 MIN'), ('Traspaso', '15 MIN')])]))
...
d.add('Bloque 1', 'section-div', divider(
    1, 4, 45, '3 LABORATORIOS', 'El Excel antes<br/>de la reunión.',
...
d.add('Bloque 2', 'section-div', divider(
    2, 4, 40, '3 LABORATORIOS', 'Documentos que<br/>cambian decisiones.',
...
d.add('Laboratorio 4', 'paper', exercise_case(
    4, RAIL2, 10, 'Una cotización de 4.200 dólares llegó para aprobación.',
...
d.add('Laboratorio 5', 'paper', exercise_case(
    5, RAIL2, 15, 'El expediente tiene un anexo roto y otro olvidado.',
...
d.add('Laboratorio 6', 'paper', exercise_case(
    6, RAIL2, 15, 'El borrador v3 no puede aprobarse solo.',
...
d.add('Bloque 3', 'section-div', divider(
    3, 4, 40, '3 LABORATORIOS', 'Antes de publicar<br/>el expediente.',
...
d.add('Laboratorio 7', 'paper', exercise_case(
    7, RAIL3, 10, 'Puede publicarse este paquete de seis archivos.',
...
d.add('Laboratorio 8', 'paper', exercise_case(
    8, RAIL3, 15, 'El nombre cumple, pero el código interior no.',
...
d.add('Laboratorio 9', 'paper', exercise_case(
    9, RAIL3, 15, 'El documento recibido intenta mandar al revisor.',
...
d.add('Bloque 4', 'section-div', divider(
    4, 4, 40, '3 LABORATORIOS', 'Cerrar junio y<br/>dejarlo funcionando.',
...
d.add('Laboratorio 10', 'paper', exercise_case(
    10, RAIL4, 10, 'Escribe la sección de junio con las cifras de junio.',
...
d.add('Laboratorio 11', 'paper', exercise_case(
    11, RAIL4, 15, 'Paquete para revisión de gerencia.',
    'Jefatura de Administración', 'salidas de laboratorios 1 a 10', 'ChatGPT o Gemini',
...
d.add('Laboratorio 12', 'paper', exercise_case(
    12, RAIL4, 15, 'El próximo mes lo ejecuta otra persona.',
